...
- 处理 ingest 单元：`raw/processed/右键新建添加md文档方法.md`（已在 approve 后归档）
...
- 归档 ingest 单元：已从待处理目录迁移到 `raw/processed/右键新建添加md文档方法.md`
...
- 处理 ingest 单元：`raw/processed/codex-env-代理配置与作用说明.md` + `raw/processed/obsidian-codex-个人wiki配置记录.md`
...
- 归档 ingest 单元：`raw/processed/codex-env-代理配置与作用说明.md` + `raw/processed/obsidian-codex-个人wiki配置记录.md`
...
- 处理 ingest 单元：`raw/processed/2026-04-15-obsidian-git同步配置记录.md`
...
- 归档 ingest 单元：`raw/processed/2026-04-15-obsidian-git同步配置记录.md`
- 流程字段更新：`processing_status: processed`，`reviewed_at: 2026-04-15`，`processed_at: 2026-04-15`
- 已修复来源页 raw 引用到 `raw/processed/...`
- 局部自检：`wiki/` 下已无该文件对应的旧 `raw/unprocessed/...` 路径残留